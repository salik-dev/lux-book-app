...
import { TooltipProvider } from "@/pages/admin/schedule/components/ui/tooltip";
import { DndProviderWrapper } from "@/pages/admin/schedule/calendar/components/dnd/dnd-provider";

import { CalendarHeader } from "@/pages/admin/schedule/calendar/components/header/calendar-header";
import { CalendarYearView } from "@/pages/admin/schedule/calendar/components/year-view/calendar-year-view";
import { CalendarMonthView } from "@/pages/admin/schedule/calendar/components/month-view/calendar-month-view";
import { CalendarAgendaView } from "@/pages/admin/schedule/calendar/components/agenda-view/calendar-agenda-view";
import { CalendarDayView } from "@/pages/admin/schedule/calendar/components/week-and-day-view/calendar-day-view";
import { CalendarWeekView } from "@/pages/admin/schedule/calendar/components/week-and-day-view/calendar-week-view";
...
export function ClientContainer({ view: viewProp }: IProps) {
  const { view: contextView, selectedDate, selectedUserId, events } = useCalendar();
