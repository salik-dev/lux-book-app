...
interface CalendarDayButtonProps extends DayContentProps {
  className?: string;
}
...
function CalendarDayButton({
  ...
  React.useEffect(() => {
    if (activeModifiers.focus) ref.current?.focus()
  }, [activeModifiers.focus])
  ...
  return (
    <Button
      ...
      data-range-middle={
        activeModifiers.range_middle || 
        (activeModifiers.in_range && !activeModifiers.range_start && !activeModifiers.range_end)
      }
      className={cn(
